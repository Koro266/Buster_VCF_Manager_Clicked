...
namespace CONTACTS.LOCAL.SECONDARY.PERSON.XTAG
{
	...
	public partial class Column
	{
		...
		public class PK_SubTag : INT_32
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.PkSubTag];
			...
			public PK_SubTag( int value ) : base( value )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public PK_SubTag( NULL_INT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
