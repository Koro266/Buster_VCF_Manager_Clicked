...
using FACTORS	= CONTACTS.LOCAL.SECONDARY.PERSON.XTAG.Constants.ColumnFactors;
...
namespace CONTACTS.LOCAL.SECONDARY.PERSON.XTAG
{
	...
	public partial class Column
	{
		...
		public class PK_Person_X_Tag : INT_32
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.PkPerson_X_Tag];
			...
			public PK_Person_X_Tag( int pk_person ) : base( pk_person )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public PK_Person_X_Tag( NULL_INT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
