...
namespace CONTACTS.LOCAL.SECONDARY.PERSON.XADDRESS
{
	...
	public partial class Column
	{
		...
		public class PK_Person_X_Address : INT_32
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.PkPerson_X_Address];
			...
			public PK_Person_X_Address( int pk_person ) : base( pk_person )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public PK_Person_X_Address( NULL_INT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
