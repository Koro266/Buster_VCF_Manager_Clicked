...
using FACTORS	= CONTACTS.LOCAL.SECONDARY.PERSON.XNOTE.Constants.ColumnFactors;
...
namespace CONTACTS.LOCAL.SECONDARY.PERSON.XNOTE
{
	...
	public partial class Column
	{
		...
		public class PK_Person_X_Note : INT_32
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.PkPerson_X_Note];
			...
			public PK_Person_X_Note( int pk_person ) : base( pk_person )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public PK_Person_X_Note( NULL_INT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
