...
using FACTORS	= CONTACTS.LOCAL.SECONDARY.PERSON.XGROUP.Constants.ColumnFactors;
...
namespace CONTACTS.LOCAL.SECONDARY.PERSON.XGROUP
{
	...
	public partial class Column
	{
		...
		public class PK_Person_X_Group : INT_32
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.PkPerson_X_Group];
			...
			public PK_Person_X_Group( int pk_person ) : base( pk_person )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public PK_Person_X_Group( NULL_INT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
