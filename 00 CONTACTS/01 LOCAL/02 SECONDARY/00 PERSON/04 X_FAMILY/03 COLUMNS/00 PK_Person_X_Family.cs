...
using FACTORS	= CONTACTS.LOCAL.SECONDARY.PERSON.XFAMILY.Constants.ColumnFactors;
...
namespace CONTACTS.LOCAL.SECONDARY.PERSON.XFAMILY
{
	...
	public partial class Column
	{
		...
		public class PK_Person_X_Family : INT_32
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.PkPerson_X_Family];
			...
			public PK_Person_X_Family( int pk_person ) : base( pk_person )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public PK_Person_X_Family( NULL_INT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
