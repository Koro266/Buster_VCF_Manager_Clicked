...
namespace CONTACTS.LOCAL.SECONDARY.PERSON.XFAMILY
{
	...
	public partial class Column
	{
		...
		public class ST_FamilyName : SHORT_TXT
		{
			#region DECLARATIONS
			private static FACTORS _columnFactors = CONST.Factors[ORDINAL.FamilyName];
			...
			public ST_FamilyName( string value ) : base( value )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public ST_FamilyName( NULL_TEXT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
