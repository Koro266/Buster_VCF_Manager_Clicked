...
namespace CONTACTS.LOCAL.SECONDARY.PERSON.XEDDRESS
{
	...
	public partial class Column
	{
		...
		public class PK_Person_X_Eddress : INT_32
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.PkPerson_X_Eddress];
			...
			public PK_Person_X_Eddress( int pk_person ) : base( pk_person )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public PK_Person_X_Eddress( NULL_INT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
