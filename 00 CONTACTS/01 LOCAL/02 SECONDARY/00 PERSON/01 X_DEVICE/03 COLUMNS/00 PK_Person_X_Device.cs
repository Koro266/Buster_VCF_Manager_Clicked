...
using FACTORS	= CONTACTS.LOCAL.SECONDARY.PERSON.XDEVICE.Constants.ColumnFactors;
...
namespace CONTACTS.LOCAL.SECONDARY.PERSON.XDEVICE
{
	...
	public partial class Column
	{
		...
		public class PK_Person_X_Device : INT_32
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.PkPerson_X_Device];
			...
			public PK_Person_X_Device( int pk_person ) : base( pk_person )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public PK_Person_X_Device( NULL_INT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
