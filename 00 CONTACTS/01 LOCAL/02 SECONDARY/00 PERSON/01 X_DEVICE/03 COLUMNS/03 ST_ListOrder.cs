...
namespace CONTACTS.LOCAL.SECONDARY.PERSON.XDEVICE
{
	...
	public partial class Column
	{
		...
		public class ST_ListOrder : SHORT_TXT
		{
			#region DECLARATIONS
			private static FACTORS _columnFactors = CONST.Factors[ORDINAL.ListOrder];
			...
			public ST_ListOrder( string value ) : base( value )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public ST_ListOrder( NULL_TEXT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
