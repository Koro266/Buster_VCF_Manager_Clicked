...
namespace CONTACTS.LOCAL.SECONDARY.PERSON.XDEVICE
{
	...
	public partial class Column
	{
		...
		public class FK_Device : INT_32
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.FkDevice];
			...
			public FK_Device( int value ) : base( value )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public FK_Device( NULL_INT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
