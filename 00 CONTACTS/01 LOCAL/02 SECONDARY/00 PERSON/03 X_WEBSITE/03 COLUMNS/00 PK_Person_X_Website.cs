...
namespace CONTACTS.LOCAL.SECONDARY.PERSON.XWEBSITE
{
	...
	public partial class Column
	{
		...
		public class PK_Person_X_Website : INT_32
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.PkPerson_X_Website];
			...
			public PK_Person_X_Website( int pk_person ) : base( pk_person )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public PK_Person_X_Website( NULL_INT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
