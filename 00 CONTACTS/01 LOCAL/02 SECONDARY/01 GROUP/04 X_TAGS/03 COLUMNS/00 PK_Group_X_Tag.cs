...
namespace CONTACTS.LOCAL.SECONDARY.GROUP.XTAG
{
	...
	public partial class Column
	{
		...
		public class PK_Group_X_Tag : INT_32
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.PkGroup_X_Tag];
			...
			public PK_Group_X_Tag( int pk_group ) : base( pk_group )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public PK_Group_X_Tag( NULL_INT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
