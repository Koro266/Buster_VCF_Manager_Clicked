...
using FACTORS	= CONTACTS.LOCAL.SECONDARY.GROUP.XWEBSITE.Constants.ColumnFactors;
...
namespace CONTACTS.LOCAL.SECONDARY.GROUP.XWEBSITE
{
	...
	public partial class Column
	{
		...
		public class PK_Group_X_Website : INT_32
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.PkGroup_X_Website];
			...
			public PK_Group_X_Website( int pk_group ) : base( pk_group )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public PK_Group_X_Website( NULL_INT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
