...
namespace CONTACTS.LOCAL.SECONDARY.GROUP.XADDRESS
{
	...
	public partial class Column
	{
		...
		public class PK_Group_X_Address : INT_32
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.PkGroup_X_Address];
			...
			public PK_Group_X_Address( int pk_group ) : base( pk_group )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public PK_Group_X_Address( NULL_INT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
