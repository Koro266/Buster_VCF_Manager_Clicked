...
namespace CONTACTS.LOCAL.SECONDARY.GROUP.XDEVICE
{
	...
	public partial class Column
	{
		...
		public class PK_Group_X_Device : INT_32
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.PkGroup_X_Device];
			...
			public PK_Group_X_Device( int pk_person ) : base( pk_person )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public PK_Group_X_Device( NULL_INT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
