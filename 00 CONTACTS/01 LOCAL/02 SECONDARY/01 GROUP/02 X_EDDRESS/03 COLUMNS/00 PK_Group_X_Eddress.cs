...
using FACTORS	= CONTACTS.LOCAL.SECONDARY.GROUP.XEDDRESS.Constants.ColumnFactors;
...
namespace CONTACTS.LOCAL.SECONDARY.GROUP.XEDDRESS
{
	...
	public partial class Column
	{
		...
		public class PK_Group_X_Eddress : INT_32
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.PkGroup_X_Eddress];
			...
			public PK_Group_X_Eddress( int pk_person ) : base( pk_person )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public PK_Group_X_Eddress( NULL_INT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
