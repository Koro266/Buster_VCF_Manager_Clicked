...
namespace CONTACTS.LOCAL.SECONDARY.GROUP.XEDDRESS
{
	...
	public partial class Column
	{
		...
		public class FK_Group : INT_32
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.FkGroup];
			...
			public FK_Group( int value ) : base( value )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public FK_Group( NULL_INT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
