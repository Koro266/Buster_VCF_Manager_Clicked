...
namespace CONTACTS.LOCAL.SECONDARY.GROUP.XNOTE
{
	...
	public partial class Column
	{
		...
		public class PK_Group_X_Note : INT_32
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.PkGroup_X_Note];
			...
			public PK_Group_X_Note( int pk_group ) : base( pk_group )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public PK_Group_X_Note( NULL_INT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
