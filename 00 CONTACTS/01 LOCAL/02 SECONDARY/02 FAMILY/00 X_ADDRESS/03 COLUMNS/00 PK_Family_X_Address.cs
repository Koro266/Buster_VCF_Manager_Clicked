...
using FACTORS	= CONTACTS.LOCAL.SECONDARY.FAMILY.XADDRESS.Constants.ColumnFactors;
...
namespace CONTACTS.LOCAL.SECONDARY.FAMILY.XADDRESS
{
	...
	public partial class Column
	{
		...
		public class PK_Family_X_Address : INT_32
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.PkFamily_X_Address];
			...
			public PK_Family_X_Address( int pk_family ) : base( pk_family )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public PK_Family_X_Address( NULL_INT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
