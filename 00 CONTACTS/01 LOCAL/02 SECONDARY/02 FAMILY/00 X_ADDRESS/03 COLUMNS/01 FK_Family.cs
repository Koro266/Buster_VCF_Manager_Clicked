...
namespace CONTACTS.LOCAL.SECONDARY.FAMILY.XADDRESS
{
	...
	public partial class Column
	{
		...
		public class FK_Family : INT_32
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.FkFamily];
			...
			public FK_Family( int value ) : base( value )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public FK_Family( NULL_INT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
