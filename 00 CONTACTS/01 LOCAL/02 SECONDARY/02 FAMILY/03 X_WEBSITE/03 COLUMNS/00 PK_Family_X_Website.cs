...
using FACTORS	= CONTACTS.LOCAL.SECONDARY.FAMILY.XWEBSITE.Constants.ColumnFactors;
...
namespace CONTACTS.LOCAL.SECONDARY.FAMILY.XWEBSITE
{
	...
	public partial class Column
	{
		...
		public class PK_Family_X_Website : INT_32
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.PkFamily_X_Website];
			...
			public PK_Family_X_Website( int pk_group ) : base( pk_group )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public PK_Family_X_Website( NULL_INT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
