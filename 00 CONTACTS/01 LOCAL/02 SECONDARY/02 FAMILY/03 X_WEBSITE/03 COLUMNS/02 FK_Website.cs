...
namespace CONTACTS.LOCAL.SECONDARY.FAMILY.XWEBSITE
{
	...
	public partial class Column
	{
		...
		public class FK_Website : INT_32
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.FkWebsite];
			...
			public FK_Website( int value ) : base( value )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public FK_Website( NULL_INT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
