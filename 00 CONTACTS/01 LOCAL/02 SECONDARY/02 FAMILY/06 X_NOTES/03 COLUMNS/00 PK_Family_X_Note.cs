...
using FACTORS	= CONTACTS.LOCAL.SECONDARY.FAMILY.XNOTE.Constants.ColumnFactors;
...
namespace CONTACTS.LOCAL.SECONDARY.FAMILY.XNOTE
{
	...
	public partial class Column
	{
		...
		public class PK_Family_X_Note : INT_32
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.PkFamily_X_Note];
			...
			public PK_Family_X_Note( int pk_family ) : base( pk_family )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public PK_Family_X_Note( NULL_INT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
