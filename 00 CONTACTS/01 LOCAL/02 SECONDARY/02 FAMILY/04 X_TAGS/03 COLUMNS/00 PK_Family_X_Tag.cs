...
namespace CONTACTS.LOCAL.SECONDARY.FAMILY.XTAG
{
	...
	public partial class Column
	{
		...
		public class PK_Family_X_Tag : INT_32
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.PkFamily_X_Tag];
			...
			public PK_Family_X_Tag( int pk_family ) : base( pk_family )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public PK_Family_X_Tag( NULL_INT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
