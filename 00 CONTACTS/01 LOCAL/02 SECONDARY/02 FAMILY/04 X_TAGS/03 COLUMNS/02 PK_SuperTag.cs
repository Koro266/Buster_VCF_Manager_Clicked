...
namespace CONTACTS.LOCAL.SECONDARY.FAMILY.XTAG
{
	...
	public partial class Column
	{
		...
		public class PK_SuperTag : INT_32
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.PkSuperTag];
			...
			public PK_SuperTag( int value ) : base( value )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public PK_SuperTag( NULL_INT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
