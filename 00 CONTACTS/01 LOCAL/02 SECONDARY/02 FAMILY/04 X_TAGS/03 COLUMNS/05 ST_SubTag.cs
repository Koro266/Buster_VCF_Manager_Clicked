...
namespace CONTACTS.LOCAL.SECONDARY.FAMILY.XTAG
{
	...
	public partial class Column
	{
		...
		public class ST_SubTag : SHORT_TXT
		{
			#region DECLARATIONS
			private static FACTORS _columnFactors = CONST.Factors[ORDINAL.SubTag];
			...
			public ST_SubTag( string value ) : base( value )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public ST_SubTag( NULL_TEXT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
