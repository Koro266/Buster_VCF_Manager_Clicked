...
using FACTORS	= CONTACTS.LOCAL.SECONDARY.FAMILY.XTAG.Constants.ColumnFactors;
...
namespace CONTACTS.LOCAL.SECONDARY.FAMILY.XTAG
{
	...
	public partial class Column
	{
		...
		public class ST_SuperTag : SHORT_TXT
		{
			#region DECLARATIONS
			private static FACTORS _columnFactors = CONST.Factors[ORDINAL.SuperTag];
			...
			public ST_SuperTag( string value ) : base( value )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public ST_SuperTag( NULL_TEXT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
			...
			//___________________________________________________________________________________________________________________________________________				
			/// <summary>				
			/// Returns true iff family has a valid AddressType value.				
			/// </summary>				
