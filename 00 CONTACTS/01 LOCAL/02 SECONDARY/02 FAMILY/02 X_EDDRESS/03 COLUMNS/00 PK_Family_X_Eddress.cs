...
namespace CONTACTS.LOCAL.SECONDARY.FAMILY.XEDDRESS
{
	...
	public partial class Column
	{
		...
		public class PK_Family_X_Eddress : INT_32
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.PkFamily_X_Eddress];
			...
			public PK_Family_X_Eddress( int pk_person ) : base( pk_person )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public PK_Family_X_Eddress( NULL_INT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
