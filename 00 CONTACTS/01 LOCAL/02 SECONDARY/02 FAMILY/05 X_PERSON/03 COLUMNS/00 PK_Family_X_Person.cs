...
using FACTORS	= CONTACTS.LOCAL.SECONDARY.FAMILY.XPERSON.Constants.ColumnFactors;
...
namespace CONTACTS.LOCAL.SECONDARY.FAMILY.XPERSON
{
	...
	public partial class Column
	{
		...
		public class PK_Family_X_Person : INT_32
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.PkFamily_X_Person];
			...
			public PK_Family_X_Person( int pk_person ) : base( pk_person )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public PK_Family_X_Person( NULL_INT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
