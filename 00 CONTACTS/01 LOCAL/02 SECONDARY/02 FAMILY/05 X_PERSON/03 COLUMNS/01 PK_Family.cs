...
namespace CONTACTS.LOCAL.SECONDARY.FAMILY.XPERSON
{
	...
	public partial class Column
	{
		...
		public class PK_Family : INT_32
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.PkFamily];
			...
			public PK_Family( int value ) : base( value )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public PK_Family( NULL_INT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
