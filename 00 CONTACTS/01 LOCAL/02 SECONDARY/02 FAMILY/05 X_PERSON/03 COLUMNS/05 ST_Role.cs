...
namespace CONTACTS.LOCAL.SECONDARY.FAMILY.XPERSON
{
	...
	public partial class Column
	{
		...
		public class ST_Role : SHORT_TXT
		{
			#region DECLARATIONS
			private static FACTORS _columnFactors = CONST.Factors[ORDINAL.Role];
			...
			public ST_Role( string value ) : base( value )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public ST_Role( NULL_TEXT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
