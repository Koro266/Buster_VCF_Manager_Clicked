...
namespace CONTACTS.LOCAL.SECONDARY.FAMILY.XPERSON
{
	...
	public partial class Column
	{
		...
		public class ST_PersonName : SHORT_TXT
		{
			#region DECLARATIONS
			private static FACTORS _columnFactors = CONST.Factors[ORDINAL.PersonName];
			...
			public ST_PersonName( string value ) : base( value )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public ST_PersonName( NULL_TEXT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
