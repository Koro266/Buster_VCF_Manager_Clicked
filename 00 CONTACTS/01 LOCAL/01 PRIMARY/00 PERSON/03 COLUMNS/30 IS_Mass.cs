...
namespace CONTACTS.LOCAL.PRIMARY.PERSON
{
	...
	public partial class Column
	{
		...
		public partial class IS_Mass : BOOL
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.Mass];
			...
			public IS_Mass( bool value ) : base( value )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public IS_Mass( NULL_BOOL tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
			...
			//___________________________________________________________________________________________________________________________________
			/// <summary>
			/// Returns Mass as used in a VCF file.
			/// </summary>
			...
			//___________________________________________________________________________________________________________________________________________
			/// <summary>
			/// Returns true if person has a valid Mass value.
			/// </summary>
