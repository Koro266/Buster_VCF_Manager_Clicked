...
namespace CONTACTS.LOCAL.PRIMARY.PERSON
{
	...
	public partial class Database
	{
		...
		public partial class Like
		{
			//___________________________________________________________________________________________________________________________________
			/// <summary>
			/// Returns PK_Person and concatenated TDF_Person rows where person Prefix begins with the given character(s).
			/// </summary>
			public class Prefix : LIKE
			{
				private readonly string target_field = "st_Prefix";
				...
				@"
					...
					FROM 
						TDF_Persons 
					WHERE 
						(((TDF_Persons.st_Prefix) Like @subtext)) 
					ORDER BY 
						TDF_Persons.st_ProperSurname;
				";
				//_______________________________________________________________________________________________________________________________
				public Prefix( string sought_after_text )
				{
