...
namespace CONTACTS.LOCAL.TERTIARY.EDDRESS
{
	...
	public partial class Database
	{
		...
		public partial class Like
		{
			...
			/// <summary>
			/// Returns pk_Device and concatenated TDF_Device rows where person ShortAreaCode begins with the given character(s).
			/// </summary>
			public class ShortAreaCode : SELECT
			{
				private readonly string target_field = "st_ShortAreaCode";
				...
				@"
					...
					FROM 
						TDF_Devices 
					WHERE 
						(((TDF_Devices.st_ShortAreaCode) Like @subtext)) 
					ORDER BY 
						TDF_Devices.st_DialNumber;
				";

				//_______________________________________________________________________________________________________________________________
				public ShortAreaCode( string sought_after_text )
				{
