...
namespace CONTACTS.LOCAL.TERTIARY.EDDRESS
{
	...
	public partial class Column
	{
		...
		public class PK_Eddress : INT_32
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.PkEddress];
			...
			public PK_Eddress( int pk_person ) : base( pk_person )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public PK_Eddress( NULL_INT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
