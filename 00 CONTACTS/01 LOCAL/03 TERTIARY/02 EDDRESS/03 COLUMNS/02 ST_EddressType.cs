...
using FACTORS	= CONTACTS.LOCAL.TERTIARY.EDDRESS.Constants.ColumnFactors;
...
namespace CONTACTS.LOCAL.TERTIARY.EDDRESS
{
	...
	public partial class Column
	{
		...
		public partial class ST_EddressType : SHORT_TXT
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.Eddress];
			...
			public ST_EddressType( string value ) : base( value )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public ST_EddressType( NULL_TEXT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
