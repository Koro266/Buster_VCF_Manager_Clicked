...
namespace CONTACTS.LOCAL.TERTIARY.DEVICE
{
	...
	public partial class Column
	{
		...
		public partial class ST_ShortAreaCode : SHORT_TXT
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.ShortAreaCode];
			...
			public ST_ShortAreaCode( string value ) : base( value )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public ST_ShortAreaCode( NULL_TEXT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
