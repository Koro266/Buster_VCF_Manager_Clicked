...
namespace CONTACTS.LOCAL.TERTIARY.DEVICE
{
	...
	public partial class Column
	{
		...
		public partial class ST_PickerNumber : SHORT_TXT
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.PickerNumber];
			...
			public ST_PickerNumber( string value ) : base( value )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public ST_PickerNumber( NULL_TEXT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
