...
namespace CONTACTS.LOCAL.TERTIARY.DEVICE
{
	...
	public partial class Column
	{
		...
		public partial class ST_DialNumber : SHORT_TXT
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.DialNumber];
			...
			public ST_DialNumber( string value ) : base( value )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public ST_DialNumber( NULL_TEXT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
