...
namespace CONTACTS.LOCAL.TERTIARY.DEVICE
{
	...
	public partial class Column
	{
		...
		public partial class ST_DeviceLocation : SHORT_TXT
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.DeviceLocation];
			...
			public ST_DeviceLocation( string value ) : base( value )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public ST_DeviceLocation( NULL_TEXT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
