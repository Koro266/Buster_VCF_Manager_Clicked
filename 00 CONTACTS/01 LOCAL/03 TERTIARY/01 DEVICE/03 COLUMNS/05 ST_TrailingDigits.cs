...
namespace CONTACTS.LOCAL.TERTIARY.DEVICE
{
	...
	public partial class Column
	{
		...
		public partial class ST_TrailingDigits : SHORT_TXT
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.TrailingDigits];
			...
			public ST_TrailingDigits( string value ) : base( value )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public ST_TrailingDigits( NULL_TEXT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
