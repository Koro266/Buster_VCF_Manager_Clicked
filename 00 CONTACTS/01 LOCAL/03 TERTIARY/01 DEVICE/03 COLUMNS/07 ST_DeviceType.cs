...
namespace CONTACTS.LOCAL.TERTIARY.DEVICE
{
	...
	public partial class Column
	{
		...
		public partial class ST_DeviceType : SHORT_TXT
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.DeviceType];
			...
			public ST_DeviceType( string value ) : base( value )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public ST_DeviceType( NULL_TEXT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
