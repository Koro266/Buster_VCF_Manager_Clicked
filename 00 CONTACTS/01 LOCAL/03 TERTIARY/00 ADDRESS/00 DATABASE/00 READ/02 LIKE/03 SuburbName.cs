...
namespace CONTACTS.LOCAL.TERTIARY.ADDRESS
{
	...
	public partial class Database
	{
		...
		public partial class Like
		{
			...
			/// SuburbName name begins with the given character(s).
			/// </summary>
			public class SuburbName : LIKE
			{
				private const string _target_Field = "st_Suburb";
				private ADDRESS_READER address_Reader;

				//___________________________________________________________________________________________________________________________
				public SuburbName( string sought_after_text )
				{
