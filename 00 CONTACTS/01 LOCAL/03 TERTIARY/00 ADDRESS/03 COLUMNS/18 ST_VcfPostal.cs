...
namespace CONTACTS.LOCAL.TERTIARY.ADDRESS
{
	...
	public partial class Column
	{
		...
		public partial class ST_VcfPostal : SHORT_TXT
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.VcfPostal];
			private static string no_VCF_Value = "vp";
			private static string no_FINDER_Value = "vp";
			...
			public ST_VcfPostal( string value ) : base( value )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public ST_VcfPostal( NULL_TEXT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
