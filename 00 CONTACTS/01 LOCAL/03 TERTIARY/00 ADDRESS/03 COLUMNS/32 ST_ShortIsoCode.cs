...
namespace CONTACTS.LOCAL.TERTIARY.ADDRESS
{
	...
	public partial class Column
	{
		...
		public partial class ST_ShortIsoCode : SHORT_TXT
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.ShortIsoCode];
			private static string no_VCF_Value = "si";
			private static string no_FINDER_Value = "si";
			...
			public ST_ShortIsoCode( string value ) : base( value )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public ST_ShortIsoCode( NULL_TEXT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
