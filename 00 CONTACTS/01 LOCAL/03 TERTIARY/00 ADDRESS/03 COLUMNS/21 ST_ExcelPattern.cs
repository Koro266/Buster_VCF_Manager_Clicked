...
namespace CONTACTS.LOCAL.TERTIARY.ADDRESS
{
	...
	public partial class Column
	{
		...
		public partial class ST_ExcelPattern : SHORT_TXT
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.ExcelPattern];
			private static string no_VCF_Value = "xl";
			private static string no_FINDER_Value = "xl";
			...
			public ST_ExcelPattern( string value ) : base( value )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public ST_ExcelPattern( NULL_TEXT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
			...
			{
				get { return base.TextboxValue == String.Empty ? no_VCF_Value : base.AsIs; }
			}
			#endregion
