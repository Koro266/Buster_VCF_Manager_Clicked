...
namespace CONTACTS.LOCAL.TERTIARY.ADDRESS
{
	...
	public partial class Column
	{
		...
		public partial class ST_City : SHORT_TXT
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.City];
			private static string no_VCF_Value = "cty,";
			private static string no_FINDER_Value = "ct";
			...
			public ST_City( string value ) : base( value )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public ST_City( NULL_TEXT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
