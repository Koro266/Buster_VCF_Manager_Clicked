...
namespace CONTACTS.LOCAL.TERTIARY.ADDRESS
{
	...
	public partial class Column
	{
		...
		public partial class ST_Level : SHORT_TXT
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.Level];
			private static string no_VCF_Value = "lvl,";
			private static string no_FINDER_Value = "lv";
			...
			public ST_Level( string value ) : base( value )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public ST_Level( NULL_TEXT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
