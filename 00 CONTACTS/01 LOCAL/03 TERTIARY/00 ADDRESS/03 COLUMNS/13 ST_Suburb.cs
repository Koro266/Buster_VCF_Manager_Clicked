...
namespace CONTACTS.LOCAL.TERTIARY.ADDRESS
{
	...
	public partial class Column
	{
		...
		public partial class ST_Suburb : SHORT_TXT
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.Suburb];
			private static string no_VCF_Value = "brb,";
			private static string no_FINDER_Value = "sb";
			...
			public ST_Suburb( string value ) : base( value )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public ST_Suburb( NULL_TEXT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
