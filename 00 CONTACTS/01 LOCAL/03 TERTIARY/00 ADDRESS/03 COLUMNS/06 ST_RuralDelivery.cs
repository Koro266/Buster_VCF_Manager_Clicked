...
namespace CONTACTS.LOCAL.TERTIARY.ADDRESS
{
	...
	public partial class Column
	{
		...
		public partial class ST_RuralDelivery : SHORT_TXT
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.RuralDelivery];
			private static string no_VCF_Value = "rd,";
			private static string no_FINDER_Value = "rd";
			...
			public ST_RuralDelivery( string value ) : base( value )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public ST_RuralDelivery( NULL_TEXT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
