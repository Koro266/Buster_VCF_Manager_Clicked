...
namespace CONTACTS.LOCAL.TERTIARY.ADDRESS
{
	...
	public partial class Column
	{
		...
		public partial class ST_StreetName : SHORT_TXT
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.StreetName];
			private static string no_VCF_Value = "snm,";
			private static string no_FINDER_Value = "sn";
			...
			public ST_StreetName( string value ) : base( value )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public ST_StreetName( NULL_TEXT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
