...
namespace CONTACTS.LOCAL.TERTIARY.ADDRESS
{
	...
	public partial class Column
	{
		...
		public partial class ST_StreetType : SHORT_TXT
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.StreetType];
			private static string no_VCF_Value = "typ,";
			private static string no_FINDER_Value = "st";
			...
			public ST_StreetType( string value ) : base( value )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public ST_StreetType( NULL_TEXT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
