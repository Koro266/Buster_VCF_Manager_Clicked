...
namespace CONTACTS.LOCAL.TERTIARY.DEVICE
{
	...
	public partial class Column
	{
		...
		public partial class IS_X_Person : BOOL
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.X_Person];
			...
			public IS_X_Person( bool value ) : base( value )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public IS_X_Person( NULL_BOOL tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
