...
namespace CONTACTS.LOCAL.TERTIARY.ADDRESS
{
	...
	public partial class Column
	{
		...
		public partial class ST_ProvinceName : SHORT_TXT
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.ProvinceName];
			private static string no_VCF_Value = "prv,";
			private static string no_FINDER_Value = "pv";
			...
			public ST_ProvinceName( string value ) : base( value )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public ST_ProvinceName( NULL_TEXT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
