...
namespace CONTACTS.LOCAL.TERTIARY.ADDRESS
{
	...
	public partial class Column
	{
		...
		public partial class ST_BoxNumber : SHORT_TXT
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.BoxNumber];
			private static string no_VCF_Value = "box,";
			private static string no_FINDER_Value = "bx";
			...
			public ST_BoxNumber( string value ) : base( value )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public ST_BoxNumber( NULL_TEXT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
