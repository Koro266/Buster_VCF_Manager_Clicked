...
namespace CONTACTS.LOCAL.TERTIARY.ADDRESS
{
	...
	public partial class Column
	{
		...
		public partial class ST_Extension : SHORT_TXT
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.Extension];
			private static string no_VCF_Value = "ext,";
			private static string no_FINDER_Value = "ex";
			...
			public ST_Extension( string value ) : base( value )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public ST_Extension( NULL_TEXT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
