...
namespace CONTACTS.LOCAL.TERTIARY.ADDRESS
{
	...
	public partial class Column
	{
		...
		public partial class ST_HouseNumber : SHORT_TXT
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.HouseNumber];
			private static string no_VCF_Value = "num,";
			private static string no_FINDER_Value = "hn";
			...
			public ST_HouseNumber( string value ) : base( value )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public ST_HouseNumber( NULL_TEXT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
