...
namespace CONTACTS.LOCAL.TERTIARY.ADDRESS
{
	...
	public partial class Column
	{
		...
		public partial class ST_Compass : SHORT_TXT
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.Compass];
			private static string no_VCF_Value = "cmp,";
			private static string no_FINDER_Value = "cp";
			...
			public ST_Compass( string value ) : base( value )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public ST_Compass( NULL_TEXT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
