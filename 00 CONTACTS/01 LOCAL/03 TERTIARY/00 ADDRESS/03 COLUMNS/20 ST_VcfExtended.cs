...
namespace CONTACTS.LOCAL.TERTIARY.ADDRESS
{
	...
	public partial class Column
	{
		...
		public partial class ST_VcfExtended : SHORT_TXT
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.VcfExtended];
			private static string no_VCF_Value = "vx";
			private static string no_FINDER_Value = "vx";
			...
			public ST_VcfExtended( string value ) : base( value )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public ST_VcfExtended( NULL_TEXT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
