...
namespace CONTACTS.LOCAL.TERTIARY.ADDRESS
{
	...
	public partial class Column
	{
		...
		public partial class ST_VcfPhysical : SHORT_TXT
		{
			#region DECLARATIONS
			private static FACTORS column_factors = CONST.Factors[ORDINAL.VcfPhysical];
			private static string no_VCF_Value = "vy";
			private static string no_FINDER_Value = "vy";
			...
			public ST_VcfPhysical( string value ) : base( value )
			{
			}
			//_______________________________________________________________________________________________________________________________________
			public ST_VcfPhysical( NULL_TEXT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
