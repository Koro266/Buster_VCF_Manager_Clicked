...
using FACTORS	= CONTACTS.LOCAL.TERTIARY.WEBSITE.Constants.ColumnFactors;		
...
namespace CONTACTS.LOCAL.TERTIARY.WEBSITE
{
	...
	public partial class Column
	{
		...
		public class PK_Website : INT_32
		{
			#region DECLARATIONS		
			private static FACTORS column_factors = CONST.Factors[ORDINAL.PkWebsite];
			...
			public PK_Website( int PkWebsite ) : base( PkWebsite )
			{
			}
			//_______________________________________________________________________________________________________________________________________	
			public PK_Website( NULL_INT tnp ) : base( tnp )
			{
				type_null_pair = tnp;
			}
			#endregion
